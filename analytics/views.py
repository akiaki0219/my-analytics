...
def index(request):
  ...
  sort, sort_option, order, compare_date_str, non_zero, non_zero_target, non_zero_option = query_strings['sort'], query_strings['sort_option'], query_strings['order'], query_strings['compare'], query_strings['non_zero'], query_strings['non_zero_target'], query_strings['non_zero_option']

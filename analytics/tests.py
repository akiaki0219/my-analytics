...
class AnalyticsViewTestCase(TestCase):
  ...
  def test_index_get_order_id(self):
    ...
    analytic1.save()
    analytic2 = Analytic(videoId=1, videoTitle="analytic1", get_at=date.today(), YouTubeView=10, YouTubeLike=30, YouTubeComment=30, niconicoView=50, niconicoLike=50, niconicoComment=70, niconicoMylist=70)
    analytic2.save()
    client = Client()
